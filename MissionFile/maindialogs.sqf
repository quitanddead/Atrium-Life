...
if (_art == "spielerliste") then
{
	...
	if(_control2 == _gangname)then{if(_territory == "None")then{_territory = "The Port"}else{_territory = _territory + ", The Port"};};
	if(_control3 == _gangname)then{if(_territory == "None")then{_territory = "East side"}else{_territory = _territory + ", East Side"};};
	if(_control4 == _gangname)then{if(_territory == "None")then{_territory = "North Side"}else{_territory = _territory + ", North Side"};};
...
_type1 = ["suburban_swat","m5_pd_traffic","UH60M_MEV_EP1","police_bell206","MH6J_EP1","OH58g","UH1H_TK_GUE_EP1","MH60S","HH65C","ibr_as350_civ","tcg_taurus_pb_2",
...
"patrol","patrol_pb","patrol_np","patrol_slick","sheriff","whiteuc","blackuc","whited","greyd","whited","blackd","tcg_suburban_uc_black","tcg_suburban_uc_grey",
"tcg_suburban_uc_white","ilpd_beat_f101","ilpd_beat_f101_sh","ilpd_scu_black","ilpd_scu_white","ilpd_unmarked_scu","ilpd_unmarked_sandstone","ilpd_unmarked_maroon",
"ilpd_unmarked_darkblue","ilpd_unmarked_black","ilpd_unmarked_grey","ilpd_unmarked_white","ilpd_slick_b40_npb","ilpd_slick_f220_npb","ilpd_slick_b40_PBG",
"ilpd_slick_f220_PBG","ilpd_Traffic_black","ilpd_Traffic_white","tcg_suburban_patrol","tcg_suburban_sheriff","suburban_pd_k9","suburban_pd","suburban_pd_sheriff",
"suburban_pd_stealth","suburban_pd_black","ilpd_scu_darkblue","ilpd_scu_grey","ilpd_scu_maroon","ilpd_scu_sandstone","ilpd_Traffic_sandstone","ilpd_Traffic_maroon",
"ilpd_Traffic_grey","ilpd_Traffic_darkblue","il_fordcv_taxi","tahoe_pd","tahoe_sh","tahoe_uc_black","tahoe_uc_grey","tahoe_uc_1_grey","tahoe_uc_1_blue","tahoe_uc_1_green",
"ilpd_slick_b40_pb","ilpd_traffic_t101","pd_cvpi_hub","pd_cvpi","tahoe_uc_maroon","tahoe_uc_white","tahoe_uc_1_maroon","tahoe_uc_1_white","tahoe_uc_1_black","ilf350swat",
"il_f350sheriff","ilpd_cvpi_pool_f101","tcg_hrlycop","ffgpd_patrol_cvpi_beat","ffgpd_patrol_cvpi_beat_lib","ffgpd_patrol_cvpi_beat_lib_no_pb","ffgpd_patrol_cvpi_beat_lib_pb_wg",
"ffgpd_patrol_cvpi_pool","ffgpd_patrol_cvpi_scu","ffgpd_patrol_cvpi_slick","ffgpd_patrol_cvpi_slick_sandstone","ffgpd_patrol_cvpi_slick_maroon","ffgpd_patrol_cvpi_slick_darkblue",
"ffgpd_patrol_cvpi_slick_black","ffgpd_patrol_cvpi_slick_grey","ffgpd_patrol_cvpi_slick_white","ffgpd_patrol_cvpi_slick_npb","ffgpd_patrol_cvpi_slick_npb_sandstone",
"ffgpd_patrol_cvpi_slick_npb_maroon","ffgpd_patrol_cvpi_slick_npb_darkblue","ffgpd_patrol_cvpi_slick_npb_black","ffgpd_patrol_cvpi_slick_npb_grey","ffgpd_patrol_cvpi_slick_npb_white",
"ffgpd_patrol_cvpi_slick_pbg","ffgpd_patrol_cvpi_traffic","ffgpd_patrol_cvpi_traffic_um","ffgpd_patrol_cvpi_traffic_um_sandstone","ffgpd_patrol_cvpi_traffic_um_maroon",
"ffgpd_patrol_cvpi_traffic_um_darkblue","ffgpd_patrol_cvpi_traffic_um_black","ffgpd_patrol_cvpi_traffic_um_grey","ffgpd_patrol_cvpi_traffic_um_white","ffgpd_patrol_cvpi_unmarked",
"ffgpd_patrol_cvpi_unmarked_sandstone","ffgpd_patrol_cvpi_unmarked_maroon","ffgpd_patrol_cvpi_unmarked_darkblue","ffgpd_patrol_cvpi_unmarked_black","ffgpd_patrol_cvpi_unmarked_grey",
