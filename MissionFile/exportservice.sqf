...
if(_stock >= _maxstock)exitwith{player groupchat "la boutique a atteint son stock maximum pour cet article / véhicule"};

['geld', _preis] call INV_AddInvItem;

player groupchat format["Le vehicule a été exporté pour $%1!", _preis];
