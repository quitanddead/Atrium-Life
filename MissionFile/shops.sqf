...
[VIPcop,"Police VIP4 Shop",VIPcop,VIPcopcarspawn,_copvip,_copvip,true],
...
//vipcopshop
[vippolice,"VIP1-3 Police",vippolicebox,VIPcopcarspawn,_doncop,_doncop,true],

[superd,"Super Club",superdb,superdspawn,_superdons,_superdons,true],
[excon,"Used Junk For ExCons",dummyobj,exconspawn,_exc,_exc,true]
];
