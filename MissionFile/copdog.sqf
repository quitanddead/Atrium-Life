...
if (_geld <= dog_cost)    exitWith {role groupChat "Vous n'avez pas assez d'argent";};
['geld', -(dog_cost)] call INV_AddInvItem;
player groupChat format["%1 a acheté un chien pour %2", rolestring, (dog_cost call ISSE_str_IntToStr)];
