...
//======================== Rob Bus ============================================
busaction1 = _role addaction ["Rob the bus driver","specialveh.sqf",["Cicada Busline"],1,false,true,"","player distance bus1 <= 5 and !iscop"];
...
action35 = _role addaction ["Gather ILLEGAL Organs","bodypart.sqf",'',1,true,true,"",'player distance (nearestobjects [getpos player, ["body"],  3] select 0) < 2'];
...
action2226 = _role addaction ["Retrieve Saved Vehicle","retrievevehicleport1.sqf",[],1,false,true,"","player distance vsave_port <= 10"];
action2227 = _role addaction ["Retrieve Saved Vehicle","retrievevehicleport2.sqf",[],1,false,true,"","player distance vsave_port2 <= 10"];
action2228 = _role addaction ["Retrieve Saved Vehicle","retrievevehicleport3.sqf",[],1,false,true,"","player distance vsave_port3 <= 10"];
action2229 = _role addaction ["Retrieve Saved Vehicle","retrievevehicleair.sqf",[],1,false,true,"","player distance vsave_air <= 10"];
...
action228 = _role addaction ["[*SAVE VEHICLE*]","noscript.sqf",'_vcl = (nearestobjects [getpos player, ["Ship"], 15] select 0);[_vcl, INV_SavedVehWater] execVM "saveVehicle.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Ship"], 15] select 0);player distance _vcl < 15 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray and _vcl distance vsave_port < 100'];
action229 = _role addaction ["[*SAVE VEHICLE*]","noscript.sqf",'_vcl = (nearestobjects [getpos player, ["Ship"], 15] select 0);[_vcl, INV_SavedVehWater] execVM "saveVehicle.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Ship"], 15] select 0);player distance _vcl < 15 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray and _vcl distance vsave_port2 < 100'];
action230 = _role addaction ["[*SAVE VEHICLE*]","noscript.sqf",'_vcl = (nearestobjects [getpos player, ["Ship"], 15] select 0);[_vcl, INV_SavedVehWater] execVM "saveVehicle.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Ship"], 15] select 0);player distance _vcl < 15 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray and _vcl distance vsave_port3 < 100'];
action231 = _role addaction ["[*SAVE VEHICLE*]","noscript.sqf",'_vcl = (nearestobjects [getpos player, ["Air"], 20] select 0);[_vcl, INV_SavedVehicleAir] execVM "saveVehicle.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Air"], 20] select 0);player distance _vcl < 20 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray and _vcl distance vsave_air < 100'];
//======================================================================================================
//======================================== SLAVES =====================================================
...
//===================================== ITEM PROCESS ==================================================
action52 = _role addaction ["Process Wood","itemprocess.sqf",["wood", "tbfour", 2, ""],1,false,true,"","player distance wood_1 <= 5 and isciv"];
...
//======================================== WORKERS =====================================================
action66 = _role addaction [format ["Buy Slave ($%1)", huren_cost],"worker1.sqf", ["holen"],1,false,true,"","(player distance b <= 2) and isciv"];
...
actionpmc2 = _role addaction ["Switch to PMC MEDIC","noscript.sqf",'["Soldier_Medic_PMC"] call clothes;',1,true,true,"",'player distance pmc < 10 and ("pmcl" call INV_HasLicense)'];
actionpmc3 = _role addaction ["Switch to PMC SNIPER","noscript.sqf",'["Soldier_Sniper_PMC"] call clothes;',1,true,true,"",'player distance pmc < 10 and ("pmcl" call INV_HasLicense)'];
actionpmc4 = _role addaction ["Switch to PMC SOLDIER","noscript.sqf",'["Soldier_PMC"] call clothes;',1,true,true,"",'player distance pmc < 10 and ("pmcl" call INV_HasLicense)'];
actionpmc5 = _role addaction ["Switch to PMC CREW","noscript.sqf",'["Soldier_Crew_PMC"] call clothes;',1,true,true,"",'player distance pmc < 10 and ("pmcl" call INV_HasLicense)'];
