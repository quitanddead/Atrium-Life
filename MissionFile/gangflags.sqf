...
if (_gangarea==gangarea1) then {_gangarea1 = "West Side Projects";};
if (_gangarea==gangarea2) then {_gangarea1 = "The Port";};
if (_gangarea==gangarea3) then {_gangarea1 = "Eastside";};
if (_gangarea==gangarea4) then {_gangarea1 = "Northside";};
