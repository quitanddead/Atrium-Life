...
{
//2000
case (_marker == "sample"):{if(_uid == "80174662") then {[_house,_housename] execVM "maphouse.sqf";} else {player groupchat "This is not owned by you";};};
//2004
case (_marker == "sample1"):{if(_uid == "3738578") then {[_house,_housename] execVM "maphouse.sqf";} else {player groupchat "This is not owned by you";};};
