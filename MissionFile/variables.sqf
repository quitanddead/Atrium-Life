...
GesetzAnzahl             = 12;
GesetzArray              = ["Always Drive on the RIGHT side of the road","Always Holster weapons in Towns.","Speed limits 50 in town 100 out", "Governor's Guards May have any weapon unlicensed","Governor is immune to traffic laws","","","","","","","","","",""];
...
slave_cost               = 10000;
slavemoneyprosekunde	 = 4000;
maxslave                 = 2;
copslaveallowed          = 0;
localslave               = 0;
localslavecounter        = 0;
huren_cost               = 10000;
hoemoneyprosekunde       = 4000;
maxhuren                 = 3;
copworkerallowed         = 0;
pimpactive               = 0;
localhuren               = 0;
...
"firetruck","rescue","Laddertruck","il_kw_tanker","il_silverado_pd","tcg_suburban_FD","ibr_as350","il_ambulance","ArmoredSUV_PMC","ffgpd_patrol_cvpi_beat",
