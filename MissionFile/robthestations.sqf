...
if (!(call INV_isArmed)) exitwith
	...
	(format ['server globalChat "The cashier at Bryces Gas n Go has just called 911 saying someone attempted to rob his gas station!";', _sel]) call broadcast;
	};
_sel = "Bryces Gas n Go";
...
if (!(call INV_isArmed)) exitwith
	...
	_sel = "Gas n Porn";
	player groupchat "You need a gun to rob the station!";
	(format ['server globalChat "The cashier at Gas n Porn has just called 911 saying someone attempted to rob his gas station!";', _sel]) call broadcast;
	};
_sel = "Gas n Porn";
(format['if(!("Robbed a gas station" in %1_reason))then{%1_reason = %1_reason + ["Robbed a gas station"]}; %1_wanted = 1; kopfgeld_%1 = kopfgeld_%1 + wantedamountforrobbing;', player]) call broadcast;
...
if (!(call INV_isArmed)) exitwith
	...
	_sel = "Gas n Pit";
	player groupchat "You need a gun to rob the station!";
	(format ['server globalChat "The cashier at Gas n Pit has just called 911 saying someone attempted to rob his gas station!";', _sel]) call broadcast;
	};
_sel = "Gas n Pit";
(format['if(!("Robbed a gas station" in %1_reason))then{%1_reason = %1_reason + ["Robbed a gas station"]}; %1_wanted = 1; kopfgeld_%1 = kopfgeld_%1 + wantedamountforrobbing;', player]) call broadcast;
...
if (!(call INV_isArmed)) exitwith
	...
	_sel = "Gas n Chips";
	player groupchat "You need a gun to rob the station!";
	(format ['server globalChat "The cashier at Gas n Chips has just called 911 saying someone attempted to rob his gas station!";', _sel]) call broadcast;
	};
_sel = "Gas n Chips";
(format['if(!("Robbed a gas station" in %1_reason))then{%1_reason = %1_reason + ["Robbed a gas station"]}; %1_wanted = 1; kopfgeld_%1 = kopfgeld_%1 + wantedamountforrobbing;', player]) call broadcast;
...
if (!(call INV_isArmed)) exitwith
	...
	player groupchat "You need a gun to rob the station!";
	(format ['server globalChat "The cashier at Mannys Gas has just called 911 saying someone attempted to rob his gas station!";', _sel]) call broadcast;
	};
_sel = "Mannys Gas Station";
(format['if(!("Robbed a gas station" in %1_reason))then{%1_reason = %1_reason + ["Robbed a gas station"]}; %1_wanted = 1; kopfgeld_%1 = kopfgeld_%1 + wantedamountforrobbing;', player]) call broadcast;
...
if (!(call INV_isArmed)) exitwith
	...
	_sel = "Mikes Hard Gas";
	player groupchat "You need a gun to rob the station!";
	(format ['server globalChat "The cashier at Mikes Hard Gas has just called 911 saying someone attempted to rob his gas station!";', _sel]) call broadcast;
	};
_sel = "Mikes Hard Gas";
(format['if(!("Robbed a gas station" in %1_reason))then{%1_reason = %1_reason + ["Robbed a gas station"]}; %1_wanted = 1; kopfgeld_%1 = kopfgeld_%1 + wantedamountforrobbing;', player]) call broadcast;
...
if (!(call INV_isArmed)) exitwith
	...
	_sel = "Gas Haus";
	player groupchat "You need a gun to rob the station!";
	(format ['server globalChat "The cashier at Gas Haus has just called 911 saying someone attempted to rob his gas station!";', _sel]) call broadcast;
	};
_sel = "Gas Haus";
(format['if(!("Robbed a gas station" in %1_reason))then{%1_reason = %1_reason + ["Robbed a gas station"]}; %1_wanted = 1; kopfgeld_%1 = kopfgeld_%1 + wantedamountforrobbing;', player]) call broadcast;
