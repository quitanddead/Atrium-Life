...
sleep 2;
convoysoldier commandMove getpos copbase1;
...
while {true} do
	...
	if (!alive convoysoldier and !_added) then 
		{
		_added = true;
		stealgovmoney = convoytruck addAction ["Steal Government salaries", "stealgovmoney.sqf",[""],1,false,true,"","isciv"];
